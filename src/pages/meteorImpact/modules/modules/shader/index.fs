...
// vars
vec3 nodeVar0; vec3 nodeVar1; vec3 nodeVar2; float nodeVar3; float nodeVar4; float nodeVar5; float nodeVar6; 
// codes
...
nodeVar0 = (normalize(nodeVary0));
	...
	nodeVar2 = _viewDir;
	nodeVar3 = (dot(nodeVar1,nodeVar2));
	nodeVar4 = clamp( nodeVar3, 0.0, 1.0 );
	nodeVar5 = (pow(nodeVar4,5.0));
...
vec3 geometryNormal = normal;
	...
	totalEmissiveRadiance = vec4( 1, 1, 1, 1 ).xyz * vec3(1);
